...
import ru.skillbox.currency.exchange.dto.RequestCurrencyDto;
...
public class CurrencyService {
    ...
    public RequestCurrencyDto getAll() {
        List<ShortCurrencyDto> shortCurrencyDtoList = repository.findAll().stream()
                .map(mapper::convertToShortDto).collect(Collectors.toList());
        return new RequestCurrencyDto(shortCurrencyDtoList);
    }
